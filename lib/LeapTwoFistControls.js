...
THREE.LeapTwoFistControls = (function () {
  ...
  LeapTwoFistControls.prototype.update = function() {
    ...
    if (persistentHands.length) {
      ...
      // translation
      if (this.shouldTranslate(aHands, persistentHands)) {
        this.applyTranslation(aHands, persistentHands);
      }
      
      // rotation
      if (this.shouldRotate(aHands, persistentHands)) {
        this.applyRotation(aHands, persistentHands);
      }

      // scale
      if (this.shouldScale(aHands, persistentHands)) {
        this.applyScale(aHands, persistentHands);
      }
    }
  ...
  LeapTwoFistControls.prototype.applyTranslation = function (anchorHands, hands) {
    var translation = this.getTranslation(anchorHands, hands);
