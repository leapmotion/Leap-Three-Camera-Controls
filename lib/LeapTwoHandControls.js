...
THREE.LeapTwoHandControls = (function () {
  ...
  var LeapTwoHandControls = function (object, controller, invert) {
    ...
    this.translationDecay = 0.85;
    this.scaleDecay = 0.5;
    this.rotationSlerp = 0.5;
    ...
    this.smoothers = [new Smoother(this.smoothingValue), new Smoother(this.smoothingValue), new Smoother(this.smoothingValue)];
  }
  ...
  LeapTwoHandControls.prototype.applyTranslation = function (anchorHands, hands) {
    ...
    translation[0] = this.smoothers[0].smoothedValue(translation[0]);
    translation[1] = this.smoothers[1].smoothedValue(translation[1]);
    translation[2] = this.smoothers[2].smoothedValue(translation[2]);
