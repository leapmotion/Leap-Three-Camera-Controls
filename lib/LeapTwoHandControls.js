...
THREE.LeapTwoHandControls = (function () {
  ...
  var LeapTwoHandControls = function (object, controller, invert) {
    ...
    this.smothers = [new Smoother(), new Smoother(), new Smoother()];
  ...
  LeapTwoHandControls.prototype.applyTranslation = function (anchorHands, hands) {
    var translation = this.getTranslation(
                                anchorHands.filter(filterEngaged),
                                hands.filter(filterEngaged));
    
    translation[0] = this.smothers[0].smoothedValue(translation[0]);
    translation[1] = this.smothers[1].smoothedValue(translation[1]);
    translation[2] = this.smothers[2].smoothedValue(translation[2]);
  ...
  function isEngaged(h) {
    return h && (h.pinchStrength > 0.5);
  }
